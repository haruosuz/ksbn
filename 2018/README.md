...
F. p.421 (図13-3).
G. 第14章
H. O2がない状態で成長しながらCO2を生成する細胞がある。 p.425. 発酵 図13-6.
```
...
問題 14-12
```
A. p.454. NAD+ 図14-10.; p.467. キノン 図14-23.
B. p.455. 図14-14.
C. p.456. 図14-15.
D. p.456. 図14-14.  
E. 
F. p.467. 図14-25. ヘム; p.472. 図14-31. クロロフィル
G. 
H. p.476. 図14-39. 図14-40. 炭素固定
```
